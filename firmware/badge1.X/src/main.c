...
120 tune 0,0,0,447\n\
130 tune 55,64,72,149\n\
140 tune 0,0,0,298\n\
150 tune 52,60,67,149\n\
160 tune 0,0,0,298\n\
170 tune 48,55,64,149\n\
180 tune 0,0,0,298\n\
190 tune 53,60,69,149\n\
200 tune 0,0,0,149\n\
210 tune 55,62,71,149\n\
220 tune 0,0,0,149\n\
230 tune 54,61,70,149\n\
240 tune 53,60,69,149\n\
250 tune 0,0,0,149\n\
260 tune 52,60,67,198\n\
270 tune 60,67,76,198\n\
280 tune 64,71,79,198\n\
290 tune 65,72,81,149\n\
300 tune 0,0,0,149\n\
310 tune 62,69,77,149\n\
320 tune 64,71,79,149\n\
330 tune 0,0,0,149\n\
340 tune 60,69,76,149\n\
350 tune 0,0,0,149\n\
360 tune 57,64,72,149\n\
370 tune 59,65,74,149\n\
380 tune 55,62,71,149\n\
390 tune 0,0,0,298\n\
400 tune 55,64,72,149\n\
410 tune 0,0,0,298\n\
420 tune 52,60,67,149\n\
430 tune 0,0,0,298\n\
440 tune 48,55,64,149\n\
450 tune 0,0,0,298\n\
460 tune 53,60,69,149\n\
470 tune 0,0,0,149\n\
480 tune 55,62,71,149\n\
490 tune 0,0,0,149\n\
500 tune 54,61,70,149\n\
510 tune 53,60,69,149\n\
520 tune 0,0,0,149\n\
530 tune 52,60,67,198\n\
540 tune 60,67,76,198\n\
550 tune 64,71,79,198\n\
560 tune 65,72,81,149\n\
570 tune 0,0,0,149\n\
580 tune 62,69,77,149\n\
590 tune 64,71,79,149\n\
600 tune 0,0,0,149\n\
610 tune 60,69,76,149\n\
620 tune 0,0,0,149\n\
630 tune 57,64,72,149\n\
640 tune 59,65,74,149\n\
650 tune 55,62,71,149\n\
660 tune 0,0,0,298\n\
670 tune 48,0,0,149\n\
680 tune 0,0,0,149\n\
690 tune 0,76,79,149\n\
700 tune 55,75,78,149\n\
710 tune 0,74,77,149\n\
720 tune 0,71,75,149\n\
730 tune 60,0,0,149\n\
740 tune 0,72,76,149\n\
750 tune 53,0,0,149\n\
760 tune 0,64,68,149\n\
770 tune 0,65,69,149\n\
780 tune 60,67,72,149\n\
790 tune 60,0,0,149\n\
800 tune 0,60,69,149\n\
810 tune 53,64,72,149\n\
820 tune 0,65,74,149\n\
830 tune 48,0,0,149\n\
840 tune 0,0,0,149\n\
850 tune 0,76,79,149\n\
860 tune 52,75,78,149\n\
870 tune 0,74,77,149\n\
880 tune 0,71,75,149\n\
890 tune 55,0,0,149\n\
900 tune 60,72,76,149\n\
910 tune 0,0,0,149\n\
920 tune 77,79,84,149\n\
930 tune 0,0,0,149\n\
940 tune 77,79,84,149\n\
950 tune 77,79,84,149\n\
960 tune 0,0,0,149\n\
970 tune 55,0,0,149\n\
980 tune 0,0,0,149\n\
990 tune 48,0,0,149\n\
1000 tune 0,0,0,149\n\
1010 tune 0,76,79,149\n\
1020 tune 55,75,78,149\n\
1030 tune 0,74,77,149\n\
1040 tune 0,71,75,149\n\
1050 tune 60,0,0,149\n\
1060 tune 0,72,76,149\n\
1070 tune 53,0,0,149\n\
1080 tune 0,64,68,149\n\
1090 tune 0,65,69,149\n\
1100 tune 60,67,72,149\n\
1110 tune 60,0,0,149\n\
1120 tune 0,60,69,149\n\
1130 tune 53,64,72,149\n\
1140 tune 0,65,74,149\n\
1150 tune 48,0,0,149\n\
1160 tune 0,0,0,149\n\
1170 tune 56,68,75,149\n\
1180 tune 0,0,0,298\n\
1190 tune 58,65,74,149\n\
1200 tune 0,0,0,298\n\
1210 tune 60,64,72,149\n\
1220 tune 0,0,0,298\n\
1230 tune 55,0,0,149\n\
1240 tune 55,0,0,149\n\
1250 tune 0,0,0,149\n\
1260 tune 48,0,0,149\n\
1270 tune 0,0,0,149\n\
1280 tune 48,0,0,149\n\
1290 tune 0,0,0,149\n\
1300 tune 0,76,79,149\n\
1310 tune 55,75,78,149\n\
1320 tune 0,74,77,149\n\
1330 tune 0,71,75,149\n\
1340 tune 60,0,0,149\n\
1350 tune 0,72,76,149\n\
1360 tune 53,0,0,149\n\
1370 tune 0,64,68,149\n\
1380 tune 0,65,69,149\n\
1390 tune 60,67,72,149\n\
1400 tune 60,0,0,149\n\
1410 tune 0,60,69,149\n\
1420 tune 53,64,72,149\n\
1430 tune 0,65,74,149\n\
1440 tune 48,0,0,149\n\
1450 tune 0,0,0,149\n\
1460 tune 0,76,79,149\n\
1470 tune 52,75,78,149\n\
1480 tune 0,74,77,149\n\
1490 tune 0,71,75,149\n\
1500 tune 55,0,0,149\n\
1510 tune 60,72,76,149\n\
1520 tune 0,0,0,149\n\
1530 tune 77,79,84,149\n\
1540 tune 0,0,0,149\n\
1550 tune 77,79,84,149\n\
1560 tune 77,79,84,149\n\
1570 tune 0,0,0,149\n\
1580 tune 55,0,0,149\n\
1590 tune 0,0,0,149\n\
1600 tune 48,0,0,149\n\
1610 tune 0,0,0,149\n\
1620 tune 0,76,79,149\n\
1630 tune 55,75,78,149\n\
1640 tune 0,74,77,149\n\
1650 tune 0,71,75,149\n\
1660 tune 60,0,0,149\n\
1670 tune 0,72,76,149\n\
1680 tune 53,0,0,149\n\
1690 tune 0,64,68,149\n\
1700 tune 0,65,69,149\n\
1710 tune 60,67,72,149\n\
1720 tune 60,0,0,149\n\
1730 tune 0,60,69,149\n\
1740 tune 53,64,72,149\n\
1750 tune 0,65,74,149\n\
1760 tune 48,0,0,149\n\
1770 tune 0,0,0,149\n\
1780 tune 56,68,75,149\n\
1790 tune 0,0,0,298\n\
1800 tune 56,65,74,149\n\
1810 tune 0,0,0,298\n\
1820 tune 60,64,72,149\n\
1830 tune 0,0,0,298\n\
1840 tune 55,0,0,149\n\
1850 tune 55,0,0,149\n\
1860 tune 0,0,0,149\n\
1870 tune 48,0,0,149\n\
1880 tune 0,0,0,149\n\
1890 tune 44,68,72,149\n\
1900 tune 0,68,72,149\n\
1910 tune 0,0,0,149\n\
1920 tune 51,68,72,149\n\
1930 tune 0,0,0,149\n\
1940 tune 0,68,72,149\n\
1950 tune 56,70,74,149\n\
1960 tune 0,0,0,149\n\
1970 tune 55,67,76,149\n\
1980 tune 0,64,72,149\n\
1990 tune 0,0,0,149\n\
2000 tune 48,64,69,149\n\
2010 tune 0,60,67,149\n\
2020 tune 0,0,0,149\n\
2030 tune 43,0,0,149\n\
2040 tune 0,0,0,149\n\
2050 tune 44,68,72,149\n\
2060 tune 0,68,72,149\n\
2070 tune 0,0,0,149\n\
2080 tune 51,68,72,149\n\
2090 tune 0,0,0,149\n\
2100 tune 0,68,72,149\n\
2110 tune 56,70,74,149\n\
2120 tune 0,67,76,149\n\
2130 tune 55,0,0,149\n\
2140 tune 0,0,0,298\n\
2150 tune 48,0,0,149\n\
2160 tune 0,0,0,298\n\
2170 tune 43,0,0,149\n\
2180 tune 0,0,0,149\n\
2190 tune 44,68,72,149\n\
2200 tune 0,68,72,149\n\
2210 tune 0,0,0,149\n\
2220 tune 51,68,72,149\n\
2230 tune 0,0,0,149\n\
2240 tune 0,68,72,149\n\
2250 tune 56,70,74,149\n\
2260 tune 0,0,0,149\n\
2270 tune 55,67,76,149\n\
2280 tune 0,64,72,149\n\
2290 tune 0,0,0,149\n\
2300 tune 48,64,69,149\n\
2310 tune 0,60,67,149\n\
2320 tune 0,0,0,149\n\
2330 tune 43,0,0,149\n\
2340 tune 0,0,0,149\n";
